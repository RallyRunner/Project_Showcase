...
class Evo:
    ...
    def evolve(self, runLength = 10, dom=100, status = 100, sync = 1000):
        ...
        while (time.time() - startTime) < duration:
            ...
            #all the issue is here -> create a new solutions . dat each time its run
            if i % sync == 0:
                try:
                    with open(path /'results/solutions.dat', 'rb') as file:
                ...
                with open(path / 'results/solutions.dat', 'wb') as file:
